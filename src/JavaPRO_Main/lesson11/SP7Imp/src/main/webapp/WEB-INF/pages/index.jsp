    ...
    <body>
        <div class="container">
           <h3><img height="50" width="55" src="<c:url value="/static/logo.png"/>"/><a href="/">Contacts List</a></h3>
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul id="groupList" class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Remote groups <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <c:forEach items="${groups}" var="group">
                                        <li>
                                            <form method="POST" action="/deleteGroup/${group.id}" style="display:inline;">
                                                <button type="submit" class="btn btn-link">Delete ${group.name} </button>
                                            </form>
                                        </li>
                                    </c:forEach>
                                </ul>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Change group to<span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <c:forEach items="${groups}" var="group">
                                        <li><a href="#" class="group-item" data-group-id="${group.id}">${group.name}</a></li>
                                    </c:forEach>
                                </ul>
                            </li>
                        </ul>
                        <form class="navbar-form navbar-left" role="search" action="/search" method="POST">
                            <div class="form-group">
                                <input type="text" class="form-control" name="pattern" placeholder="Search" style="border-radius: 5px; border: 1px solid #ccc; padding: 5px 10px;">
                            </div>
                            <button type="submit" class="btn btn-default" style="border-radius: 5px; background-color: #f0f0f0; color: #333; border: 1px solid #ccc; padding: 5px 10px;">Submit</button>
                        </form>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
            </nav>
            ...
            <form action="/uploadContacts" method="post" enctype="multipart/form-data">
        ...
        <script>
            ...
            $('.dropdown-menu li a').click(function(){
                ...
                let data = { groupId: groupId, contacts: contacts };
                $.ajax({
                    type: "POST",
                    url: "/contact/switchGroup",
