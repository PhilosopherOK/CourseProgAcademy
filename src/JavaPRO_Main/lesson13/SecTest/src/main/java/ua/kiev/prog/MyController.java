...
public class MyController {
    ...
    @PostMapping(value = "/blockedUnblocked")
    @PreAuthorize("hasRole('ROLE_ADMIN')") // SpEL !!!
    public String blockedUnblockedUsers(@RequestParam(name = "toBlockUnblock[]", required = false) List<Long> ids,
                               Model model) {
        userService.blockedUnblockedUsers(ids);
        model.addAttribute("users", userService.getAllUsers());
    ...
    @GetMapping("/register")
    @PreAuthorize("!hasRole('ROLE_MODERATOR')") // SpEL !!!
    public String register() {
        return "register";
    }

    @GetMapping("/admin")
    @PreAuthorize("hasRole('ROLE_ADMIN') || hasRole('ROLE_MODERATOR')") // SpEL !!!
